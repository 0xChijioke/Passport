...
The scorer API enables developers to interact with the Gitcoin Passport ecosystem by performing various operations, such as obtaining the scorer message, signing the message, submitting the passport for scoring, and retrieving the passport score.

By leveraging the Gitcoin Scorer API, developers can seamlessly incorporate passport scoring functionality into their applications and enhance the user experience with sybil resistance testing.

To use the Gitcoin Scorer API, ensure that you have the necessary API key, which can be obtained from the Gitcoin developer portal. This API key will be used to authenticate your requests to the scorer API.
🚀 Getting Started

    Clone the repository and navigate to the project directory.
    Install the dependencies by running npm install or yarn install.
    Set up your environment variables, including the Gitcoin Scorer API key and other required configuration values.
    Start the development server with  yarn start.
    Start a local chain  yarn chain.
    Deploy on the local chain with  yarn deploy.
...
## Quickstart with scaffold-eth 2
